...
//				"is_success,response_Code,response_Msg,field");
	 ...
	 * @return
	 */
	public static List<KlhEdbOrder> edbTradeGet(Date queryStartDate) {
...
//						System.out.println("receiver_mobile: "+element.elementText("receiver_mobile"));
						...
						if(!StringUtils.isBlank(mobile)){//手机号不为空情况下
							String transactionId = element.elementText("transaction_id");
							
							String proTotalfee = element.elementText("pro_totalfee");
							String orderTotalfee = element.elementText("order_totalfee");
							...
							edbOrder.setMobile(mobile);
							edbOrder.setTransactionId(transactionId);
							edbOrder.setOrderTotalfee(orderTotalfee);
							edbOrder.setProTotalfee(proTotalfee);
