...
public class VoteController {
	...
	public String voteInfo(Model model) {
	...
	public String voteInfo(Model model, int voteId, @RequestParam(value="openid", required=false, defaultValue="") String openid) {
	...
	public String vote(Model model, int voteId) {
		KlhVote voteInfo = klhVoteService.loadById(voteId);
		if(voteInfo!=null&&voteInfo.getId()>0){
			model.addAttribute("voteInfo", voteInfo);
