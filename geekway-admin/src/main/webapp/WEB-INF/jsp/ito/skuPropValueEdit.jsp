...
<%@page import="com.bruce.geekway.model.ItoSkuPropValue"%>
...
<body class="sidebar-wide">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<%
			ItoSkuPropValue skuPropValue = (ItoSkuPropValue)request.getAttribute("skuPropValue");
			%>

			<form id="validate" action="<s:url value='./saveSkuPropValue'/>" method="post"  class="form-horizontal form-bordered">
				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>编辑SKU属性值
						</h6>
					</div>
