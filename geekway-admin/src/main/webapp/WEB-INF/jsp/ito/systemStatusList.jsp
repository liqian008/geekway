...
<%@page import="com.bruce.geekway.model.ItoSystemStatus"%>
			...
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<%
                           	List<ItoSystemStatus> systemStatusList = (List<ItoSystemStatus>)request.getAttribute("systemStatusList");
                           	if(systemStatusList!=null&&systemStatusList.size()>0){
                           		int i=0;
                           		for(ItoSystemStatus systemStatus: systemStatusList){
                           			i++;
                           	%>
							<tr>
		                        <td><%=i%></td>
