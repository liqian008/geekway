...
<%@page import="com.bruce.geekway.model.ItoWwjRecord"%>
			...
			<div class="panel panel-default">
				...
				<div class="datatable-media">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<%
                           	List<ItoWwjRecord> wwjRecordList = (List<ItoWwjRecord>)request.getAttribute("wwjRecordList");
                           	if(wwjRecordList!=null&&wwjRecordList.size()>0){
                           		int i=0;
                           		for(ItoWwjRecord wwjRecord: wwjRecordList){
                           			i++;
                           	%>
							<tr>
		                        <td><%=i%></td>
		                        <td><%=wwjRecord.getOpenId()%></td>
		                        <td>已申请</td>
		                        <td><%=wwjRecord.getCreateTime()%></td>
		                        <td class='text-center'>
		                        	<div class="table-controls">
										<a href="./wwjRecordEdit?wwjRecordId=<%=wwjRecord.getId()%>"
											class="btn btn-link btn-icon btn-xs tip" title=""
											data-original-title="个人资料"><i class="icon-pencil3"></i></a> 
									</div>
								</td>
                               </tr>
							<%}
