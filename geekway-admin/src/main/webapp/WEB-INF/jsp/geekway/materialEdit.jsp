...
<body class="sidebar-wide">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<%
			WxMaterial material = (WxMaterial)request.getAttribute("material");
			%>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<%
								short materialType = (short)1;
								if(material!=null&&material.getId()!=null){//<!-- 编辑状态下 -->
									materialType = material.getMaterialType();
								}else{//<!-- 新增状态下 -->
									materialType = (Short)request.getAttribute("materialType");
								}%>
								<label class="control-label">
									<%=displayMaterialType(materialType) %>
								</label>
								<input type="hidden" class="form-control" name="materialType" id="materialType" value="${materialType}"/>
								<form:hidden path="material.id"/>
								<form:hidden path="material.messageId"/>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">文本内容: <span class="mandatory">*</span></label>
							
							<div class="col-sm-6">
								<textarea name="shortContent" rows="2" cols="5" class="elastic form-control" placeholder="上限100字">${material.shortContent}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="shortTitle" id="shortTitle" value="${material.shortTitle}"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<!-- 
								<input type="text" class="form-control" name="coverImageUrl" id="coverImageUrl" value="${material.coverImageUrl}"/>
								<img src="http://www.jinwanr.com.cn/staticFile/image/20140306/medium/100012_bb6d4f45aacd9b97a91063cda17cd3b3.jpg" width="160px"/>
								-->
								<a href="${material.coverImageUrl}" id="cover-image-link"  class="lightbox">
									<img id="cover-image" src="${material.coverImageUrl}" width="200px" />
								</a>
								<input id="cover-image-url" type="hidden" name="coverImageUrl" value="${material.coverImageUrl}"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<form:select path="material.status" class="select-liquid">
