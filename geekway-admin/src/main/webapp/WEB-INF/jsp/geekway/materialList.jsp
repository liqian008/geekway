		...
		<div class="page-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<a href="./materialAdd?type=2"><span class="label label-danger pull-right">新增图文素材</span></a>
					<a href="./materialAdd?type=1"><span class="label label-info pull-right">新增文本素材</span></a>
				</div> 
