...
<body class="sidebar-wide">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<%
			KlhSetting setting = (KlhSetting)request.getAttribute("setting");
			%>

			<form id="validate" action="<s:url value='./saveSetting'/>" method="post"  class="form-horizontal form-bsettinged">

				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>可乐惠设置
						</h6>
					</div>
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<form:select path="setting.bindRealname" class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<form:select path="setting.bindMobile" class="form-control">
									<form:option value="0"  label="否"/>
									<form:option value="1"  label="是"/>
								</form:select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<form:select path="setting.bindBirthday" class="form-control">
									<form:option value="0"  label="否"/>
									<form:option value="1"  label="是"/>
								</form:select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<form:select path="setting.bindEmail" class="form-control">
									<form:option value="0"  label="否"/>
									<form:option value="1"  label="是"/>
								</form:select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<form:select path="setting.bindAddress" class="form-control">
									<form:option value="0"  label="否"/>
									<form:option value="1"  label="是"/>
								</form:select>
							</div>
						...
						<div class="form-group"> 
							...
							<div class="col-sm-2"> 
								<input type="text" class="form-control" name="bindScore" id="bindScore" value="${setting.bindScore}"/>
							</div>
						</div>
