...
<body class="sidebar-wide">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<form id="validate" action="<s:url value='./saveSetting'/>" method="post"  class="form-horizontal form-bordered">

				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>可乐惠用户资料
						</h6>
					</div>
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">用户OpenID: <span class="mandatory">*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="userOpenId" id="userOpenId" value="${user.userOpenId}"/>
							</div>
						</div>
						
						
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">昵称: <span class="mandatory">*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">姓名: <span class="mandatory">*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">手机号: <span class="mandatory">*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group"> 
							<label class="col-sm-2 control-label text-right">地址: <span class="mandatory">*</span></label>
							<div class="col-sm-8"> 
