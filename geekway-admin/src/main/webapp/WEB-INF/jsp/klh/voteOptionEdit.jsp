				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<a href="${voteOption.picUrl}" id="cover-image-link"  class="lightbox">
									<img id="cover-image" src="${voteOption.picUrl}" width="200px" />
								</a>
								<input id="cover-image-url" type="hidden" name="picUrl" value="${voteOption.picUrl}"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="title" id="title" value="${voteOption.title}"/>
							</div>
							<input type="hidden" name="id" id="id" value="${voteOption.id}"/>
							<input type="hidden" name="voteId" id="voteId" value="${voteOption.voteId}"/>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="block-inner">
									<textarea name="description" rows="2" cols="5" class="elastic form-control" placeholder="上限100字">${voteOption.description}</textarea>
								</div>
							</div>
						</div> 
						...
						<div class="form-group">
							...
							<div class="col-sm-1">
								<input type="text" class="form-control" name="sort" id="sort" value="${voteOption.sort}"/>
							</div>
						</div>
