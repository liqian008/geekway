						...
						<tbody>
							...
							<tr>
		                        ...
		                        <td class="text-center">
		                        	<a href="<%=wallImage.getPicUrl()%>" class="lightbox">
		                        	<img src='<%=wallImage.getThumbPicUrl()%>' class="img-media"/>
		                        	</a> 
		                        </td>
		                        <td><%=wallImage.getNickname()%></td>
		                        <td><%=wallImage.getLikeCount()%></td>
		                        <td class='text-center'>
		                        	<div class="table-controls">
										<a href="./wallImageEdit?wallImageId=<%=wallImage.getId()%>"
