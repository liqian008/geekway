...
<body class="sidebar-wide">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<form id="validate" action="<s:url value='./saveWallImage'/>" method="post" class="form-horizontal form-bordered">

				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>照片墙详情
						</h6>
					</div>
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<a href="${wallImage.picUrl}" id="cover-image-link"  class="lightbox">
									<img id="cover-image" src="${wallImage.picUrl}" width="200px" />
								</a>
							</div> 
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<label class="control-label">${wallImage.nickname}</label>
								<form:hidden path="wallImage.id"/>
							</div> 
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<form:select path="wallImage.status" class="select-liquid">
