...
<%@page import="com.bruce.geekway.model.KlhProductOrder"%>
			...
			<div class="panel panel-default">
				...
				<div class="datatable-media">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<%
                           	List<KlhProductOrder> productOrderList = (List<KlhProductOrder>)request.getAttribute("productOrderList");
                           	if(productOrderList!=null&&productOrderList.size()>0){
                           		int i=0;
                           		for(KlhProductOrder productOrder: productOrderList){
                           			i++;
                           	%>
							<tr>
		                        <td><%=i%></td>
		                        <td title="<%=productOrder.getDescription()%>"><%=productOrder.getTitle()%></td>
		                        <td><%=productOrder.getScore()%>分</td>
		                        <td title="<%=productOrder.getPostAddress()%>"><%=productOrder.getPostName()%></td>
		                        <td><%=productOrder.getPostMobile()%></td>
		                        <td class='text-center'>
		                        	<div class="table-controls">
										<a href="./productOrderDisplay?productOrderId=<%=productOrder.getId()%>"
