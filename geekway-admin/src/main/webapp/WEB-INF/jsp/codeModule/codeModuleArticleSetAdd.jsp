				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="title" id="title" value="${codeModule.moduleName}" readonly="readonly"/>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h5 class="panel-title">
						<i class="icon-checkbox-partial"></i>关联新文章
					</h5>
					<a href="./codeModuleArticleSet?codeModuleId=${codeModule.id}"><span class="label label-danger pull-right">返 回</span></a>
				</div>
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-check">
						...
						<tbody>
							<%
                           	List<WxArticle> articleList = (List<WxArticle>)request.getAttribute("unmappedArticleList");
							...
							<tr>
		                        ...
		                        <td class='text-center'>
		                        	<div class="table-controls">
										<a href="./addCodeModuleArticle?codeModuleId=${codeModule.id}&articleId=<%=article.getId()%>"  
