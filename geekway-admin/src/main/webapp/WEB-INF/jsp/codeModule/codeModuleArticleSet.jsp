		...
		<div class="page-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<a href="./codeModuleArticleSetAdd?codeModuleId=${codeModule.id}"><span class="label label-danger pull-right">关联新文章</span></a>
				</div>
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-check">
						...
						<tbody>
							<%
                           	List<WxArticle> articleList = (List<WxArticle>)request.getAttribute("mappedArticleList");
							...
							<tr>
		                        ...
		                        <td class='text-center'>
		                        	<div class="table-controls">
		                        		<a href="./removeCodeModuleArticle?codeModuleId=${codeModule.id}&articleId=<%=article.getId()%>"  
