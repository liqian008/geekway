				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">资讯标题: <span class="mandatory">*</span></label>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">资讯短标题: <span class="mandatory">*</span>
							</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="shortTitle" id="shortTitle" value="${news.shortTitle}"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<a href="${news.coverImageUrl}" id="cover-image-link"  class="lightbox">
									<img id="cover-image" src="${news.coverImageUrl}" width="200px" />
								</a>
								<input id="cover-image-url" type="hidden" name="coverImageUrl" value="${news.coverImageUrl}"/>
								<input type="file" name="thumbImage" id="cover-image-file" class="styled">
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-2 control-label text-right">资讯内容概要: <span class="mandatory">*</span>
							</label>
							<div class="col-sm-10"> 
								<div class="block-inner">
									<textarea name="shortContent" rows="6" cols="5" class="elastic form-control" placeholder="上限100字">${news.shortContent}</textarea>
								</div>
							</div>
						</div>
						 
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">资讯内容详情: <span class="mandatory">*</span>
							</label>
							<div class="col-sm-10"> 
								<div class="block-inner">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">资讯链接: <span class="mandatory">*</span>
							</label>
							<div class="col-sm-6">
								<label class="control-label">
									<%
										String newsLink = ArticleLinkUtil.getArticleLink(news.getId());
									%>
									<%=newsLink%>
									<a href="<%=newsLink%>" target="_blank" id="changeMaterial"><span class="label label-info">预 览</span></a>
								</label>
							</div>
						</div>
						<%}%>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<form:select path="news.status" class="select-liquid">
