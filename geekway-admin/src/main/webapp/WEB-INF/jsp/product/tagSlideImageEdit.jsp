	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="callout callout-info fade in">
				...
				<h5>功能介绍：</h5>
				<p>
					1、轮播图片，为保证用户体验，建议不超过4组，且图片尺寸规格相同，不超过600x600<br/>
				</p>
			</div>
			...
			<form id="validate" action="<s:url value='./saveTagSlideImage'/>" method="post"  class="form-horizontal form-bordered">
				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>编辑Tag图片 
						</h6>
					</div>
					<div class="panel-body">
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">Tag名称: <span class="mandatory">*</span></label>
							<div class="col-sm-3">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
	                            ...
	                            <input type="hidden" name="rootId" value="${productTag.id}">
							</div>
						</div>
