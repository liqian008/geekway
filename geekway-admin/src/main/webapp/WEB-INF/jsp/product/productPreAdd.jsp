	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="callout callout-info fade in">
				...
				<h5>功能介绍</h5>
				<p>
					1、新增商品前需要先选择其所属分类<br/>
				</p>
			</div>

			<form id="validate" action="<s:url value='./productAdd'/>" method="get"  class="form-horizontal form-bordered">

				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>请先选择商品所属分类
						</h6>
					</div>
