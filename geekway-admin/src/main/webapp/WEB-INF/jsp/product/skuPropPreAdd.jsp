	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="callout callout-info fade in">
				...
				<h5>功能介绍</h5>
				<p>
					1、新增Sku属性前需要先选择其所属分类<br/>
				</p>
			</div>

			<form id="validate" action="<s:url value='./skuPropAdd'/>" method="get"  class="form-horizontal form-bordered">

				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>请先选择所属分类
						</h6>
					</div>
