...
<body class="sidebar-wide">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<form id="validate" action="<s:url value='./saveJsapi'/>" method="post"  class="form-horizontal form-bordered">

				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>编辑Jsapi详情
						</h6>
					</div>
					<div class="panel-body">
					
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">API: <span class="mandatory">*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="apiName" id="apiName" value="${jsapi.apiName}"/>
								<form:hidden path="jsapi.id"/>
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">中文名称: <span class="mandatory">*</span>
							</label>
							<div class="col-sm-6"> 
								<div class="block-inner">
								<input type="text" class="form-control" name="name" id="name" value="${jsapi.name}"/>
								</div>
							</div>
						</div>
