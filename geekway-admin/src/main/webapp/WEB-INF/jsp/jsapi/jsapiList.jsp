			...
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped dataTable">
						...
						<tbody>
							<%
							List<WxJsapi> jsapiList = (List<WxJsapi>)request.getAttribute("jsapiList");
                           	if(jsapiList!=null&&jsapiList.size()>0){
                           		int i=0;
                           		for(WxJsapi jsapi: jsapiList){
                           			i++;
                           	%>
							<tr>
								<td><%=i%></td>
		                        <td><%=jsapi.getApiName()%></td>
		                        <td><%=jsapi.getName()%></td> 
		                        <td><%=jsapi.getStatus()==(short)1?"启用":"禁用"%></td>
		                        <td><%=sdf.format(jsapi.getCreateTime())%></td>
		                        <td class='text-center'>
		                        	<div class="table-controls">
										<a href="./jsapiEdit?id=<%=jsapi.getId()%>"
