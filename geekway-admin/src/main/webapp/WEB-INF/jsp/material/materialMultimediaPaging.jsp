			...
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped dataTable">
						...
						<tbody>
							<%
							PagingResult<WxMaterialMultimedia> pagingResult = (PagingResult<WxMaterialMultimedia>)request.getAttribute("materialMultimediaPagingData");
							List<WxMaterialMultimedia> materialList = pagingResult.getPageData();
							if(materialList!=null&&materialList.size()>0){
                           		int i=0;
                           		for(WxMaterialMultimedia material: materialList){
                           			i++;
                           	%>
							<tr>
		                        <td><%=i%></td>
		                        ...
		                        <td>
	                        		...
	                        		<a href="<%=material.getMediaUrl()%>" class="lightbox">
		                        		<img src='<%=material.getMediaUrl()%>' class="img-media"/>
		                        	</a>
		                        ...
		                        <td class='text-center'>
		                        	<div class="table-controls">
										...
										<a href="./materialMultimediaEdit?materialId=<%=material.getId()%>"
											class="btn btn-link btn-icon btn-xs tip" title=""
											data-original-title="编 辑"><i class="icon-pencil3"></i></a> 
										<a href="./delMaterialMultimedia?materialId=<%=material.getId()%>" 
											class="btn btn-link btn-icon btn-xs tip" title=""
