			...
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped dataTable">
						...
						<tbody>
							<%
							PagingResult<WxMaterialNews> pagingResult = (PagingResult<WxMaterialNews>)request.getAttribute("materialNewsPagingData");
							List<WxMaterialNews> materialNewsList = pagingResult.getPageData();
