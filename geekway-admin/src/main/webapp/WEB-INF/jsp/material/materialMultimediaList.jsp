...
<%@page import="com.bruce.geekway.model.WxMaterialMultimedia"%>
			...
			<div class="panel panel-default">
				...
				<div class="datatable-media">
					<table class="table table-bordered table-striped">
						...
						<tbody>
							<%
                           	List<WxMaterialMultimedia> materialList = (List<WxMaterialMultimedia>)request.getAttribute("materialMultimediaList");
