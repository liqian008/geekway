			...
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped dataTable">
						...
						<tbody>
							<%
							PagingResult<WxMaterialArticle> pagingResult = (PagingResult<WxMaterialArticle>)request.getAttribute("materialArticlePagingData");
							List<WxMaterialArticle> materialArticleList = pagingResult.getPageData();
