			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h5 class="panel-title">
						<i class="icon-checkbox-partial"></i>关联新资源
					</h5>
					<a href="./commandMaterialSet?commandId=${command.id}"><span class="label label-danger pull-right">返 回</span></a>
				</div>
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-check">
						...
						<tbody>
							<%
                           	List<WxMaterial> materialList = (List<WxMaterial>)request.getAttribute("unmappedMaterialList");
							...
							<tr>
		                        ...
		                        <td class='text-center'>
		                        	<div class="table-controls">
										<a href="./addCommandMaterial?commandId=${command.id}&materialId=<%=material.getId()%>"  
