...
<body class="sidebar-wide">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<form id="validate" action="<s:url value='./appPaging'/>" method="post" >
				<!-- Basic inputs -->
				<div class="panel panel-default">
					...
					<div class="panel-body"> 
						<div class="form-group">
							<div class="row">
								<div class="col-md-4">
									<label>告警类型:</label><input type="text" name="resourceName" placeholder="支持模糊匹配" class="form-control" value="${resourceName}"> 
								</div>
							</div>
						</div>
			...
			<div class="panel panel-default">
				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped dataTable">
						...
						<tbody>
							<%
							PagingResult<WxApp> pagingResult = (PagingResult<WxApp>)request.getAttribute("appPagingData");
							List<WxApp> appList = pagingResult.getPageData();
							...
							<tr>
		                        ...
		                        <td class='text-center'>
		                        	<div class="table-controls">
										<a href="./appEdit?appId=<%=app.getId()%>"
