...
<body class="sidebar-wide">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<form id="validate" action="<s:url value='./saveCp'/>" method="post"  class="form-horizontal form-bordered">

				<!-- Basic inputs -->
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>编辑应用详情
						</h6>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6"> 
								<div class="block-inner">
									<textarea name="description" rows="3" cols="5" class="elastic form-control" placeholder="上限200字">${defaultReply.newSubscribeReply}</textarea>
								</div>
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">AppKey: <span class="mandatory">*</span></label>
							<div class="col-sm-4">
								<label class="control-label">${app.appKey}</label>
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">SecretKey: <span class="mandatory">*</span></label>
							<div class="col-sm-6">
								<label class="control-label">${app.secretKey}</label>
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">返回游戏地址: <span class="mandatory">*</span>
							</label>
							<div class="col-sm-6"> 
								<div class="block-inner">
									<input type="text" class="form-control" name="backGameUrl" id="backGameUrl" value="${app.backGameUrl}"/>
								</div>
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">支付通知URL: <span class="mandatory">*</span>
							</label>
							<div class="col-sm-10"> 
								<div class="block-inner">
									<label class="control-label">${app.payNotifyUrl}</label>
								</div>
							</div>
						</div>
