...
<%@page import="com.bruce.geekway.model.enumeration.*"%>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6"> 
								<div class="block-inner">
									<textarea name="description" rows="3" cols="5" class="elastic form-control" placeholder="上限200字"></textarea>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="wxAppId" id="wxAppId"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" name="wxAppSecret" id="wxAppSecret"/>
							</div>
						</div>
					</div>
					...
					<div class="panel-heading">
						<h6 class="panel-title">
							<i class="icon-bubble4"></i>Jsapi权限配置
						</h6>
					</div>
					<div class="panel-body">	
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">可选微信JS权限: <span class="mandatory">*
							</label>
							<div class="col-sm-10">
								<%
                               		...
                               		for(WxJsapi loopJsapi: allJsapiList){
										...
										%>
	                               		<div class="checkbox checkbox-info">
											<label>
											<input class="styled" type="checkbox" name="jsapiIds" id="jsapiId_<%=loopJsapi.getId()%>" value="<%=loopJsapi.getId()%>"/>
