        ...
        <div class="content"> 
            ...
            <div class="container">
                ...
                <div class="center-text">
                	...
                	<input type="text" name="student" value="1" data-age="18" />
					<input type="text" name="student" value="2" data-age="19" />
					<input type="text" name="student" value="3" data-age="20" />
...
$("#submitOrder").click(function(){
	...
	//var chenked=$("input[type='hidden']").val([]);
	//var paramData  =  {"productSkuId":chenked};
	//$("input[name='productSkuId']").each(function(){
	//    alert($(this).val());
	//});
	
	var student = $("input[name='student']").serialize();
	alert(student);
    var paramData  =  {"student": student};
	
	$.post('${pageContext.request.contextPath}/test.json', paramData, function(responseData) {
