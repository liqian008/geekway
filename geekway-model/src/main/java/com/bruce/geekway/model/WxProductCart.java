...
public class WxProductCart {
	...
	public static class CartProductSku {
		...
		private WxProductSku productSku;
		private int amount;
		...
		public CartProductSku(WxProductSku productSku, int amount) {
			super();
		...
		public WxProductSku getProductSku() {
			return productSku;
		}

		public void setProductSku(WxProductSku productSku) {
			this.productSku = productSku;
		}
