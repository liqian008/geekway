...
public class WxMpOauthService extends WxBaseService {
	...
	public WxOauthTokenResult getOauthAccessToken(String code) {
		...
		String oauthResult = WxUtil.sendGetRequest(ConfigUtil.getString("weixinmp_oauth_accesstoken_url"), params);
	...
	public WxUserInfoResult getOauthUserinfo(String accessToken, String openid) {
		...
		String userinfoResultStr = WxUtil.sendGetRequest(ConfigUtil.getString("weixinmp_oauth_userinfo_url"), params); 
