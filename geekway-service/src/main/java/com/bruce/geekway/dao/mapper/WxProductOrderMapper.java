...
public interface WxProductOrderMapper {
	 ...
	 * @mbggenerated  Sat Sep 27 17:24:11 CST 2014
	 */
	int updateByExampleSelective(@Param("record") WxProductOrder record, @Param("example") WxProductOrderCriteria example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table wx_product_order
	 * @mbggenerated  Sat Sep 27 17:24:11 CST 2014
	 */
	int updateByExample(@Param("record") WxProductOrder record, @Param("example") WxProductOrderCriteria example);
