...
public interface WxCustomizeMenuMapper {
	 ...
	 * @mbggenerated  Wed May 07 16:06:52 CST 2014
	 */
	int updateByExampleSelective(@Param("record") WxCustomizeMenu record,
			@Param("example") WxCustomizeMenuCriteria example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table wx_customize_menu
	 * @mbggenerated  Wed May 07 16:06:52 CST 2014
	 */
	int updateByExample(@Param("record") WxCustomizeMenu record,
			@Param("example") WxCustomizeMenuCriteria example);
