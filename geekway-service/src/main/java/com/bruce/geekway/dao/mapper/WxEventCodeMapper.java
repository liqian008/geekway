...
public interface WxEventCodeMapper {
	 ...
	 * @mbggenerated  Tue Apr 15 14:23:08 CST 2014
	 */
	int updateByExampleSelective(@Param("record") WxEventCode record,
			@Param("example") WxEventCodeCriteria example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table wx_event_code
	 * @mbggenerated  Tue Apr 15 14:23:08 CST 2014
	 */
	int updateByExample(@Param("record") WxEventCode record,
			@Param("example") WxEventCodeCriteria example);
