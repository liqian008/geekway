...
public interface KlhVoteMapper {
	 ...
	 * @mbggenerated  Sat May 31 18:27:44 CST 2014
	 */
	int updateByExampleSelective(@Param("record") KlhVote record, @Param("example") KlhVoteCriteria example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table klh_vote
	 * @mbggenerated  Sat May 31 18:27:44 CST 2014
	 */
	int updateByExample(@Param("record") KlhVote record, @Param("example") KlhVoteCriteria example);
