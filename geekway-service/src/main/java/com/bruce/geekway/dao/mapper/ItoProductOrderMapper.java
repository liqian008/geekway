...
public interface ItoProductOrderMapper {
	 ...
	 * @mbggenerated  Wed Dec 24 21:27:12 CST 2014
	 */
	int updateByExampleSelective(@Param("record") ItoProductOrder record,
			@Param("example") ItoProductOrderCriteria example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table ito_product_order
	 * @mbggenerated  Wed Dec 24 21:27:12 CST 2014
	 */
	int updateByExample(@Param("record") ItoProductOrder record,
			@Param("example") ItoProductOrderCriteria example);
